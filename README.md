...
Pre-built packages for x86-64-v3 CPU architectures are available for Debian and Ubuntu users on the [release page](https://github.com/Blobfolio/pxsum/releases/latest), and to Arch Linux users via [AUR](https://aur.archlinux.org/packages/pxsum-bin) (thanks[@murlakatamenka](https://github.com/murlakatamenka)!).

To use pxsum in other environments, it'll need to be built from source.
